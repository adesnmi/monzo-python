...
qthelp:
	...
	@echo "# qcollectiongenerator $(BUILDDIR)/qthelp/MonzoPython.qhcp"
	@echo "To view the help file:"
	@echo "# assistant -collectionFile $(BUILDDIR)/qthelp/MonzoPython.qhc"

.PHONY: applehelp
applehelp:
	$(SPHINXBUILD) -b applehelp $(ALLSPHINXOPTS) $(SOURCEDIR) $(BUILDDIR)/applehelp
	@echo
...
devhelp:
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/MonzoPython"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/MonzoPython"
	@echo "# devhelp"
...
.PHONY: epub3
epub3:
	$(SPHINXBUILD) -b epub3 $(ALLSPHINXOPTS) $(SOURCEDIR) $(BUILDDIR)/epub3
	@echo
...
.PHONY: dummy
dummy:
	$(SPHINXBUILD) -b dummy $(ALLSPHINXOPTS) $(SOURCEDIR) $(BUILDDIR)/dummy
	@echo
